guard :concat, :type => "css", :files => %w[], :input_dir => "public/assets/css", :output => "public/assets/css/styles.min"

guard :concat, :type => "js", :files => %w[], :input_dir => "public/assets/js", :output => "public/assets/js/scripts.min"
...
guard :sass, :input => 'app/assets/sass', :output => 'public/assets/css', :input => 'app/assets/scss'